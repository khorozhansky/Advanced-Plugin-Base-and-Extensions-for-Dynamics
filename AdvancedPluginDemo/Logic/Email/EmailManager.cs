namespace AdvancedPluginDemo.Logic.Email
{
  using System;
  ...
  public class EmailManager: ManagerBase<Email, ExtendedOutOfBoxTraceLog>
  {
    ...
    private void ProcessRecipientsChange()
    {
      ...
      if (ccExt.IsModified)
      {
        ...
        SimpleValueExt<OptionSetValue, Email> priorityExt = entityExt.GetSimpleValueExt(()=>targetEntity.PriorityCode);
