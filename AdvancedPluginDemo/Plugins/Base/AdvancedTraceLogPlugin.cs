namespace AdvancedPluginDemo.Plugins.Base
{
  ...
  /// <seealso cref="AdvancedTraceLogPluginBase{TEntity,TContext}" />
  /// <remarks>
  ...
  /// </remarks>
  public abstract class AdvancedTraceLogPlugin<TEntity> : AdvancedTraceLogPluginBase<TEntity, CrmContext>
    where TEntity : Entity, new()
  {
    protected AdvancedTraceLogPlugin(string unsecureConfig, string secureConfig) 
